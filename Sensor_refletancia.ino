...
int leitura_sensor() 
{
  ...
  int num_sensor = 4;
  unsigned int leitura[4];  //cria vetor para armazenamento dos dados

  leitura[0]  = analogRead(sensor1);
  leitura[1]  = analogRead(sensor2);
  leitura[2]  = analogRead(sensor3);
  leitura[3]  = analogRead(sensor4);
